<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shangjiaguanli.aspx.cs" Inherits="shangjiaguanli" %>
             ...
             <%------------------功能按钮区第1部分：角色分类---商家/助学管理员----------%>
                 ...
                 <%------------------功能按钮区第2部分：角色分类---商家/助学管理员----------%>
                            <button class="layui-btn layui-btn-danger">
                             ...
                             <button class="layui-btn layui-btn-danger" onclick="delAll(<%# Eval("M_LoginId") %>)">
                 ...
                 <div class="layui-card-body layui-table-body layui-table-main">
                    <asp:Repeater ID="rpTest" runat="server">
                         ...
                         <ItemTemplate>
                           <tr>
                            <td>
                                <input value="<%# Eval("M_LoginId") %>" class="bb" type="checkbox" name="id" lay-skin="primary" > 
                            </td>
                            <td><%# Eval("M_LoginId") %></td>
                            <td><%# Eval("M_Password") %></td>
                            <td><%# Eval("Identification") %></td>
                            <td><%# Eval("M_Name") %></td>
                            ...
                            <td class="td-manage">    
                               <a title="编辑岗位状态" onclick="xadmin.open('修改岗位状态','JobEditState.aspx?id=<%# Eval("M_LoginId") %>',457,650)" href="javascript:;">
                                <i class="layui-icon">&#xe631;</i></a>

                               <a title="修改商家信息" onclick="xadmin.open('编辑工作岗位信息','EdItManager.aspx?id=<%# Eval("M_LoginId") %>',600,400)"  href="javascript:;">
                                <i class="layui-icon">&#xe643;</i> </a>

                                <a title="删除" onclick="Jobdel(this,'<%# Eval("M_LoginId") %>')" href="javascript:;" class="delete">
                                <i class="layui-icon">&#xe640;</i> </a>

                               <a title="查看岗位详情" onclick="xadmin.open('查看岗位状态','shangjiaxiangqing.aspx?id=<%# Eval("M_LoginId") %>',457,650)" href="javascript:;">
                                <i class="layui-icon">&#xe631;</i></a>
     ...
     //});
        ...
        function Jobdel(obj, id) {
            layer.confirm('确认要删除吗？', function (index) {
                ...
                $.ajax({
                    type: "post",
                    url: "shangjiaguanli.aspx/deleteByID",
                    data: "{ID:'" + id + "'}",
