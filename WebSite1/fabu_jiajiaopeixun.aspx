<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fabu_jiajiaopeixun.aspx.cs" Inherits="fabu_jiajiaopeixun" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div id="zhiwei">
                ...
                <asp:Button ID="Button" runat="server" Text="家教"   />
                <asp:Button ID="Button21" runat="server" Text="助教"  />
                <asp:Button ID="Button31" runat="server" Text="才艺老师" />
                <asp:Button ID="Button41" runat="server" Text="辅导培训" />
