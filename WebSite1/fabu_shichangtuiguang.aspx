<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fabu_shichangtuiguang.aspx.cs" Inherits="fabu_shichangtuiguang" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div id="zhiwei">
                ...
                <asp:Button ID="Button21" runat="server" Text="扫码推广"  />
                <asp:Button ID="Button31" runat="server" Text="校园代理" />
                <asp:Button ID="Button41" runat="server" Text="销售" />
                <asp:Button ID="Button51" runat="server" Text="促销" />
                <asp:Button ID="Button61" runat="server" Text="问卷调查" Height="43px" Width="133px"  />
                <asp:Button ID="Button71" runat="server" Text="其他推广" />
