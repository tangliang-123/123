<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fabu_wenyuanzhuli.aspx.cs" Inherits="fabu_wenyuanzhuli" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div id="zhiwei">
                ...
                <asp:Button ID="Button" runat="server" Text="行政/文员"   />
                <asp:Button ID="Button21" runat="server" Text="运营/运营助理"  />
                <asp:Button ID="Button31" runat="server" Text="资料录入" />
                <asp:Button ID="Button41" runat="server" Text="信息标注" />
