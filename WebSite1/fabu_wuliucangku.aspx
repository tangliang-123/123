<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fabu_wuliucangku.aspx.cs" Inherits="fabu_wuliucangku" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div id="zhiwei">
                ...
                <asp:Button ID="Button" runat="server" Text="打包分拣"   />
                <asp:Button ID="Button21" runat="server" Text="物流配送"  />
