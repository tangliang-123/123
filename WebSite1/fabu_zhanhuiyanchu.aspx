<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fabu_zhanhuiyanchu.aspx.cs" Inherits="fabu_zhanhuiyanchu" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div id="zhiwei">
                ...
                <asp:Button ID="Button" runat="server" Text="活动协助/执行"   />
                <asp:Button ID="Button21" runat="server" Text="节目观众"  />
