        ...
        <div class="main">
            <div class="left">
                ...
                <div class="leftx">
                    ...
                    <p class="p4">
                        <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="Black" PostBackUrl="~/wxtz.aspx">微信通知</asp:LinkButton></p>
                    <p class="p4">
                        <asp:LinkButton ID="LinkButton3" runat="server" ForeColor="Black" PostBackUrl="~/yjtz.aspx">邮件通知</asp:LinkButton></p>
                </div>
            </div>
            <div class="right">
