...
<body>
    ...
    <div>
        ...
        <asp:LinkButton ID="LinkButton8" runat="server">已结束</asp:LinkButton><asp:Label ID="Label14" runat="server" Text="0"></asp:Label>
        <asp:LinkButton ID="LinkButton9" runat="server">审核中</asp:LinkButton><asp:Label ID="Label15" runat="server" Text="0"></asp:Label>
        <asp:LinkButton ID="LinkButton10" runat="server">审核驳回</asp:LinkButton><asp:Label ID="Label16" runat="server" Text="0"></asp:Label>
